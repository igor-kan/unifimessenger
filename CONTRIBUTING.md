# Contributing to unifimessenger

Thank you for your interest in contributing to unifimessenger! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/unifimessenger.git
   cd unifimessenger
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/unifimessenger.git
   ```
...
By contributing to unifimessenger, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
